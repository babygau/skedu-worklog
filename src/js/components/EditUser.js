...
@connect(state => ({
  ...
  editWorklogs: state.editWorklog.data}))
export default class EditUser extends Component {

  constructor(props) {
    super(props)
    let {key, firstname, lastname, gender, homephone, mobile, dob, address, email, ssn, ssn_expirydate, isAdmin, bankname1, bankname2, holdername1, holdername2, bsb1, bsb2, accno1, accno2} = this.props.editUser
    let {editWorklogs} = this.props
    this.worklogDataSet = new TableDataSet([])
    this.state = {
      worklogs: editWorklogs,
      key: key,
      firstname: firstname,
      lastname: lastname,
      gender: gender,
  ...
  _onNext() {
    $('#edit-tabs a[href="#bank-info"]').tab('show')
  }

  _onPrev() {
    $('#edit-tabs a[href="#basic-info"]').tab('show')
  }
  ...
  componentDidMount() {
    ...
    this.worklogDataSet.setData(this.state.worklogs)
  }
  ...
  render() {
    ...
    return (
      <section className='app__main col-sm-9 col-md-9 col-lg-9'>
        <div className='modal fade' role='dialog' id='failed-update'>
        ...
        <div className='row'>
          <ul id='edit-tabs' className='nav nav-tabs'>
            <li><a className='active' href='#basic-info'>Basic Information</a></li>
            <li><a href='#bank-info'>Bank Detail</a></li>
            <li><a href='#user-worklogs'>Worklogs</a></li>
          </ul>
        </div>
        <div className='row'>
          <br />
          <div className='tab-content col-sm-12 col-md-12 col-lg-12'>
            <div id='user-worklogs' className='tab-pane fade'>
              <BootstrapTable data={this.worklogDataSet} striped={true} hover={true}>
            ...
            <div id='basic-info' className='tab-pane fade in active'>
              ...
              <div className='form-group row'>
                <div className='col-sm-5 col-md-5 col-lg-5'>
                  ...
                  <input id='firstname-input' onChange={this._onFirstNameChange} value={firstname} type='text' className='form-control'/>
                </div>

                <div className='col-sm-5 col-md-5 col-lg-5'>
                  <label htmlFor='lastname-input' className='control-label'>Last Name</label>
                  <input id='lastname-input' onChange={this._onLastNameChange} value={lastname} type='text' className='form-control'/>
                </div>
              </div>
